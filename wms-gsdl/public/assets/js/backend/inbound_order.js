define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'inbound_order/index' + location.search,
                    add_url: 'inbound_order/add',
                    edit_url: 'inbound_order/edit',
                    del_url: 'inbound_order/del',
                    multi_url: 'inbound_order/multi',
                    import_url: 'inbound_order/import',
                    table: 'inbound_order',
                }
            });
