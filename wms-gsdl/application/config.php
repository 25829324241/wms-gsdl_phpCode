...
return [
    ...
    //内部Lot_api地址
    'in_api_url'=>'http://172.29.129.107:9811/api/v1/',
    //iot api
    'iot_api_url'=>'http://172.29.129.107:9811/api/v1/',
    //内部api通讯key
    'base_api_key'=>'96b0b7fbde387c08dc61b699995f4e79',
    'base_api_url'=>'http://172.29.129.107:9811/api/v1/',
    //白名单ip
    'whitelist_ip'=>['1172.29.129.107'],
    //白名单url 用于 api 无校验内部调用
    'whitelist_url'=>[
        '/api/v1/warehouse_api/tote_inbound',
        '/api/v1/warehouse_api/tote_outbound',
        '/api/v1/warehouse_api/callback_task',
        '/api/v1/warehouse_api/bz_callback_task',
        '/api/v1/test/action_test',
        '/GHKLkFhjsA.php',
        ],
];
