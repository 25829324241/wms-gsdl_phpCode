...
class Conveyor extends Model
{
    ...
    {
        return $this->belongsTo('WarehouseLocation', 'wh_l_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
    ...
    {
        return $this->belongsTo('Workbench', 'real_station', 'real_station', [], 'LEFT')->setEagerlyType(0);
    }
}
