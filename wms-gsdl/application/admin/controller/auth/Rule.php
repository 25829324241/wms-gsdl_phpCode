...
class Rule extends Backend
{
    ...
    public function _initialize()
    {
        ...
        // 必须将结果集转换为数组
        $ruleList = \think\Db::name("auth_rule")->field('type,condition,remark,createtime,updatetime', true)->order('id ASC')->select();
        foreach ($ruleList as $k => &$v) {
            $v['title'] = __($v['title']).'(cid:'.$v['cid'].')';
        }
        unset($v);
