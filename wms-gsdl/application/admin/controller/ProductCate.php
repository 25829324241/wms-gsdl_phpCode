...
class ProductCate extends Backend
{
    ...
    /**
     * ProductCate模型对象
     * @var \app\common\model\ProductCate
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\common\model\ProductCate;
    ...
    public function edit($ids = null)
    {
        ...
        if ($params['pid'] != $row['pid']) {
            $childrenIds = Tree::instance()->init(collection(ProductCateModel::select())->toArray())->getChildrenIds($row['id']);
